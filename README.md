...
The current version has been tested and works with 7.15.X but will probably work fine with any version form 7.4.X upward. Pylon does not curently support Umbraco 8 and, as yet, there are no plans to do so.
...
* [http://www.minotech.co.uk/developers/open-source-projects](http://www.minotech.co.uk/developers/open-source-projects)
